...
### **`Service`**
The pure unit of work — focused, atomic, and honest about what it does.  
...
- Long ago I fought an `enterprise API` from a `big company` that returned four completely different response formats.  
  ...
  *(Yes, I’m not kidding, an API returning HTML.)*
...
- It's funny that my poor unpain AI assitant can **generate `Flow` from `Service` and `Kit` interface** (which made by the poor Architect guy) and workflow PDF (made by poor BA guy) - I don't even code yet, poor me 
