...
that felt just like the old SQL days - **One UPDATE summoning an entire army of triggers.**

And to solve that…
they added `Redis` to reduce the request rate hitting their server.  
(**Yes, they added fuel to the fire.)*

*Sometimes I wonder **what that poor system ever did to them**,
why they keep throwing stones at it even when it’s already down.*  
...
**This is how the caching ladder looks like.**
```text
...
1. **We only use **reflection's read feature****  
    **Write feature is like The Book Of Solomon, it scary!*
2. **Reflection must **go with cache****.
3. **Reflection can **only use** to implement meta feature**.  
    *if your presentation layer uses reflection, you gonna want to refactor.*
4. **Don't abuse or misuse reflection**  
    **It hurts me when type this but I must, poor me*
...
***Q. Book of Solomon wtf??***  
*A. It summons demons. Do you really want your junior to overwrite your entire project?*

***Q. Why don’t you abuse the write-side of Reflection?***  
*A. Because it can bypass Chimera, I absolutely hate that!*

***Q. So what happended to the team on your story?***.  
