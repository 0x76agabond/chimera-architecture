...
*If this chapter feels difficult to follow, you can use the shortcut* [*here*](https://github.com/0x76agabond/chimera-architecture/blob/main/Pattern/10.%20vision.md)

---
Ok, I'm gonna admit it — this `“3 levels of DI”` thing is not that special.  
It’s basically the lifecycle of a dependency, written out loud instead of being quietly assumed.

Most modern DI systems assume that every dependency is available at construction time.    
**But in real systems, many dependencies simply don’t exist at initialization time.**

- Some dependencies don’t exist when your service starts.
- Some dependencies change depending on runtime context.
- Sometimes you wish you could transform or replace a dependency mid-run without restarting the whole application.

**A simple example is a Service controlling a WPF form:**  
...
**And then your manager changes the report format and UI every two days.**  
