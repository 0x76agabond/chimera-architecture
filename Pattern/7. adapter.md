...
(**Yes, atleast I reinvent `Hexa Architecture`)*
...
3. You don't have to handle anything at the time it touch your server. Just leave it in any kind of storage then do the job when your server got resouce.  
