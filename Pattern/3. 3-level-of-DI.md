...
*The `3 levels of DI` & `manipulation thing` probably made you expect reflection, remote threading etc...*

But those features are out of scope,
so I’ll just give you some ideas to mess around with.

You shouldn’t use these things in production code, it's for security or experiments only.
